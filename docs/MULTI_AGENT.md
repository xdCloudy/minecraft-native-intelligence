...
Many persistent runtimes should share expensive foundation inference while isolating identities, memories, relationships, goals, and optional adapters. Scheduling must handle different tick budgets, proximity, activity, sleep/idle states, batching compatibility, and backpressure without allowing one slow agent to freeze the world.
